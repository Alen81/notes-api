...
class FolderPost(object):
    ...
    @property
    def name(self):
        """Gets the name of this FolderPost.  # noqa: E501


        :return: The name of this FolderPost.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FolderPost.


        :param name: The name of this FolderPost.  # noqa: E501
        :type: str
        """
